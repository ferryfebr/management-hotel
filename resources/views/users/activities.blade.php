            ...
            @foreach($rows as $a)
                ...
                <div class="flex items-start gap-3 px-4 py-3 hover:bg-gray-50">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        @if($a['type'] === 'kamar')
                            @if(!empty($a['photo']))
                                <a href="{{ $a['photo'] }}" target="_blank" class="inline-flex items-center gap-2 mt-1.5 text-xs text-gray-500 hover:text-gray-700">
                                    <img src="{{ $a['photo'] }}" alt="Foto bukti kerja"
                                         class="w-12 h-12 object-cover rounded border border-gray-200">
                                    Lihat foto bukti
                                </a>
                            @else
                                <p class="text-xs text-gray-400 mt-1 italic">Tidak ada gambar yang di-upload.</p>
                            @endif
                        @endif
                    </div>
